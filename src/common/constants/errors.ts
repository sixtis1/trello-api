export const errors = {
  ...
  COLUMN_ALREADY_EXISTS: 'A column with this name already exists for the user.',
  COLUMN_DOESNT_EXISTS: 'A column with this id does not exist.',
  ...
  COMMENT_ALREADY_EXISTS:
    'A comment with this name already exists for the user.',
};
